...
`SettingsManager` stores application preferences in a separate `settings.json` beside the platform save directory. It never modifies campaign slots, whose schema remains version 2. Application settings use schema version 1:
