...
Music contexts cover the World Map, Verdant levels, Emberfall Ravine, ruins, Ashen Warden, and World Complete. Explicitly owned ambience covers Verdant wind, canopy, ravine, ruins, and Sanctum. F7, replay, life/boss reset, transitions, and shutdown rebuild one correct context without leaking loops. Debug `F8` toggles mute. Campaign saves remain free of playback state and audio preferences.
